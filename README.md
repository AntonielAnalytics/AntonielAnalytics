...
<h3 align="center">Data Analyst & Business Intelligence em formação | Graduando em Ciência da Computação</h3>

---

## Sobre

Sou graduando em **Ciência da Computação (5º período)**, com foco em **Análise de Dados e Business Intelligence**. Possuo sólida base em lógica de programação e estrutura de dados, buscando transformar dados em **insights estratégicos para apoio à tomada de decisão**.
...
Abaixo estão meus projetos desenvolvidos com foco em **Análise de Dados e Business Intelligence**, aplicando conceitos de **modelagem de dados, análise exploratória e visualização de informações** para apoio à tomada de decisão.
