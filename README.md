<h2 align="left">Olá 👋! Meu nome é Antoniel Bezerra Silva e sou um Data Analyst & BI em formação, de Teresina, Piauí, Brasil.</h2>

[cite_start]<h3 align="left">Graduando em Ciência da Computação (4º período)[cite: 21], focado em Data Analytics e Business Intelligence (BI). [cite_start]Utilizo Python, SQL e Power BI para transformar dados em *insights* estratégicos e apoiar a tomada de decisão *Data-Driven*[cite: 17, 18, 22].</h3>
